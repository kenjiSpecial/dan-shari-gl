 ...
 * @param type
 */
export declare function createEmptyTexture(gl: WebGLRenderingContext, textureWidth: number, textureHeight: number, format?: number, minFilter?: number, magFilter?: number, wrapS?: number, wrapT?: number, type?: number): WebGLTexture;
...
export declare function updateEmptyImageTexture(gl: WebGLRenderingContext, texture: WebGLTexture, textureWidth: number, textureHeight: number, format?: number, minFilter?: number, magFilter?: number, wrapS?: number, wrapT?: number, type?: number): WebGLTexture;
/**
 *
 * @param gl
 * @param texture
